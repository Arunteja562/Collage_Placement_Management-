...
function UserDetails() {
  document.title = 'Aurora | Complete Profile';
                  ...
                  (<>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <div className=" py-3 flex flex-wrap gap-2">
                            <FloatingLabel controlId="floatingSem1" label="Term 1">
                              <Form.Control
                                type="number"
                                placeholder=" 1"
                                name='Term1'
                            ...
                            <FloatingLabel controlId="floatingSem2" label="Term 2">
                              <Form.Control
                                type="number"
                                placeholder="Term 2"
                                name='Term2'
                            ...
                            <FloatingLabel controlId="floatingSem3" label="Term 3">
                              <Form.Control
                                type="number"
                                placeholder="Term 3"
                                name='Term3'
                            ...
                            <FloatingLabel controlId="floatingTerm4" label="Term 4">
                              <Form.Control
                                type="number"
                                placeholder="Term 4"
                                name='Term4'
                          ...
                          <div className=" py-3 flex flex-wrap gap-2">
                            <FloatingLabel controlId="floatingSem5" label="Term 5">
                              <Form.Control
                                type="number"
                                placeholder="Term 5"
                                name='Term5'
                            ...
                            <FloatingLabel controlId="floatingSem6" label="Term 6">
                              <Form.Control
                                type="number"
                                placeholder="Term 6"
                                name='Term6'
                                value={userData?.studentProfile?.CGPA?.Term6}
                                onChange={handleDataChangeForSGPA}
                                // required={completeProfileReq}
                                disabled={!completeProfileReq && currentUserData.role !== 'superuser'}
                              />
                            </FloatingLabel>
                            <FloatingLabel controlId="floatingSem7" label="Term 7">
                              <Form.Control
                                type="number"
                                placeholder="Term 7"
                                name='Term7'
                                value={userData?.studentProfile?.CGPA?.Term7}
                                onChange={handleDataChangeForSGPA}
                                // required={completeProfileReq}
                                disabled={!completeProfileReq && currentUserData.role !== 'superuser'}
                              />
                            </FloatingLabel>
                            <FloatingLabel controlId="floatingSem8" label="Term 8">
                              <Form.Control
                                type="number"
                                placeholder="Term 8"
                                name='Term8'
                                value={userData?.studentProfile?.CGPA?.Term8}
                                onChange={handleDataChangeForSGPA}
                                // required={completeProfileReq}
                                disabled={!completeProfileReq && currentUserData.role !== 'superuser'}
                              />
                    ...
                    <div className="backdrop-blur-md bg-white/30 border border-white/20 rounded-lg shadow shadow-red-400 p-6 my-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3">
                        <div className="px-2 py-3 flex flex-col gap-2">
                          <FloatingLabel controlId="floatingSelectSSC" label="SSC Board Name">
                            ...
                            >
                              ...
                              <option value="Telangana State Board of Secondary and Higher Education (TSBSHE)">Telangana State Board of Secondary and Higher Education (TSBSHE)</option>
                              <option value="Andhra Pradesh State Board of Secondary and Higher Education (APSBSHE)">Andhra Pradesh State Board of Secondary and Higher Education (APSBSHE)</option>
                        ...
                        <div className="px-2 py-3 flex flex-col gap-2">
                          <FloatingLabel controlId="floatingSelectHSC" label="Intermediate Board Name">
                            ...
                            >
                              ...
                              <option value="Telangana State Board of Intermediate and Higher Education (TSBIHE)">Telangana State Board of Intermediate and Higher Education (TSBIHE)</option>
                              <option value="Andhra Pradesh State Board of Intermedite and Higher Education (APSBIHE)">Andhra Pradesh State Board of Intermediate and Higher Education (APSBIHE)</option>
                              <option value="Central Board of Secondary Education (CBSE)">Central Board of Intermediate Education (CBIE)</option>
                              <option value="Council for the Indian School Certificate Examinations (CISCE)">Council for the Indian School Certificate Examinations (CISCE)</option>
                              <option value="Other">Other</option>
                            </Form.Select>
                          </FloatingLabel>
                          <FloatingLabel controlId="floatingHSCMarks" label="Inter Percentage">
                            <Form.Control
                              type="number"
                        ...
                        <div className="px-2 py-3 flex flex-col gap-2">
                          <FloatingLabel controlId="floatingSelectDiploma" label="Degree Board Name">
                            <Form.Select
                              aria-label="Floating label select Degre Board"
                              className='cursor-pointer'
                              name='degreeBoard'
                          ...
                          <FloatingLabel controlId="floatingDiplomaMarks" label="Degree Percentage or CGPA">
                            <Form.Control
                              type="number"
                          ...
                          <FloatingLabel controlId="floatingSelectDegreePassingYear" label="Degree Passing Year">
                            <Form.Control
                              type="number"
