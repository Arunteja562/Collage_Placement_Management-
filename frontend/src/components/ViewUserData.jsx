...
function ViewUserData() {
  document.title = 'Aurora | User Details';
                          ...
                          {userData?.studentProfile?.SGPA && (
                            <>
                              <div className="flex flex-col gap-3">
                                <div className="font-bold">CGPA:</div>
                                  ...
                                  <div className="space-y-6 max-sm:space-y-3">
                                    {
                                      userData?.studentProfile?.SGPA?.sem1 && (
                                        <div className='border-2 px-2 rounded transition-all duration-200 cursor-pointer hover:scale-125 hover:bg-green-200'>
                                          <span className="text-gray-700 font-bold">Term I: </span>
                                          <span className="text-gray-800">
                                            {userData?.studentProfile?.SGPA?.Term1}
                                          </span>
                                        </div>
                                      )
                                    }
                                    {
                                      userData?.studentProfile?.SGPA?.sem2 && (
                                        <div className='border-2 px-2 rounded transition-transform duration-200 cursor-pointer hover:scale-125 hover:bg-green-200'>
                                          ...
                                          <span className="text-gray-800">
                                            {userData?.studentProfile?.SGPA?.Term2}
                                          </span>
                                        </div>
                                    ...
                                    }
                                    {
                                      userData?.studentProfile?.SGPA?.sem3 && (
                                        <div className='border-2 px-2 rounded transition-transform duration-200 cursor-pointer hover:scale-125 hover:bg-green-200'>
                                          <span className="font-bold text-gray-700">Term III: </span>
                                          <span className="text-gray-800">
                                            {userData?.studentProfile?.SGPA?.Term3}
                                          </span>
                                        </div>
                                      )
                                    }
                                    {
                                      userData?.studentProfile?.SGPA?.sem4 && (
                                        <div className='border-2 px-2 rounded transition-transform duration-200 cursor-pointer hover:scale-125 hover:bg-green-200'>
                                          <span className="text-gray-700 font-bold">Term IV: </span>
                                          <span className="text-gray-800">
                                            {userData?.studentProfile?.SGPA?.Term4}
                                          </span>
                                        </div>
                                      )
                                    }
                                  ...
                                  <div className="space-y-6 max-sm:space-y-3">
                                    {
                                      userData?.studentProfile?.SGPA?.sem5 && (
                                        <div className='border-2 px-2 rounded transition-transform duration-200 cursor-pointer hover:scale-125 hover:bg-green-200'>
                                          <span className="font-bold text-gray-700 ">Term V: </span>
                                          <span className="text-gray-800">
                                            {userData?.studentProfile?.SGPA?.Term5}
                                          </span>
                                        </div>
                                      )
                                    }
                                    {
                                      userData?.studentProfile?.SGPA?.sem6 && (
                                        <div className='border-2 px-2 rounded transition-transform duration-200 cursor-pointer hover:scale-125 hover:bg-green-200'>
                                          <span className="font-bold text-gray-700 ">Term VI: </span>
                                          <span className="text-gray-800">
                                            {userData?.studentProfile?.SGPA?.Term6}
                                          </span>
                                        </div>
                                      )
                                    }
                                    {
                                      userData?.studentProfile?.SGPA?.sem7 && (
                                        <div className='border-2 px-2 rounded transition-transform duration-200 cursor-pointer hover:scale-125 hover:bg-green-200'>
                                          <span className="font-bold text-gray-700 ">Term VII: </span>
                                          <span className="text-gray-800">
                                            {userData?.studentProfile?.SGPA?.Term7}
                                          </span>
                                        </div>
                                      )
                                    }
                                    {
                                      userData?.studentProfile?.SGPA?.sem8 && (
                                        <div className='border-2 px-2 rounded transition-transform duration-200 cursor-pointer hover:scale-125 hover:bg-green-200'>
                                          <span className="font-bold text-gray-700 ">Term VIII: </span>
                                          <span className="text-gray-800">
                                            {userData?.studentProfile?.SGPA?.Term8}
                                          </span>
                                        </div>
                                      )
                                    }
